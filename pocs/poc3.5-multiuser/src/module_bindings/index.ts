...
import EventCombatRow from "./event_combat_table";
...
const tablesSchema = __schema({
  creature: __table({
    ...
    indexes: [
      ...
      { name: 'creature_owner', algorithm: 'btree', columns: [
        'owner',
      ] },
    ],
    constraints: [
...
const reducersSchema = __reducers(
  __reducerSchema("move_creature", MoveCreatureReducer),
  __reducerSchema("reset", ResetReducer),
  __reducerSchema("spawn_creature", SpawnCreatureReducer),
);
